...
function getBlogbyId (){
    ...
    for (let i = 0; i < listOfPost.length; i++) {
        if(bloggId === listOfPost[i].id){
            ...
            let propContainer: HTMLDivElement = document.createElement("div");
            propContainer.className = "prop-container";
            heroContainer.appendChild(propContainer);

            let userContainer: HTMLDivElement = document.createElement("div");
            userContainer.className = "user-container";
            propContainer.appendChild(userContainer);
            ...
            propContainer.appendChild(titleContainer);
            ...
            propContainer.appendChild(textContainer);
            ...
            propContainer.appendChild(dateContainer);
